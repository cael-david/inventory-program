...
class Api:
    ...
    def delete_stock(self, stock_id):
        try:
            ...
            # Remove todas as entradas do estoque
            cursor.execute("DELETE FROM stock_entries WHERE stock_id = ?", (stock_id,))
            # Agora remove o estoque em si
            ...
            if rowcount == 0:
                ...
                return {'success': True, 'message': 'Stock and its entries (if any) removed successfully!'}
